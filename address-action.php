          ...
          <div class="col-8 mx-auto">
                ...
                <div class="shadow-lg bg-white mt-4 p-4">
					<?php
							...
							echo "<h3 class='text-center m-4'>New Address Added successfully</h3><form action='dashboard_admin.php'><button class='btn btn-block login-btn' type='submit'>OK</button></form>";
